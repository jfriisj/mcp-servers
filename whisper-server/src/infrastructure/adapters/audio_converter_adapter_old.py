...
class AudioConverterAdapter(IAudioConverter):
    """
    Audio/video format conversion adapter implementing domain interface.

    Provides conversion between audio formats using FFmpeg or librosa,
    with support for video audio extraction.
    """
