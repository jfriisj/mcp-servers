"""
Database connection and lifecycle management for Study Buddy MCP Server.
...
class DatabaseConnection:
    ...
    def __init__(self, database_path: str = "data/study_buddy.db"):
        """
    ...
    def execute(self, query: str, parameters: tuple = ()) -> sqlite3.Cursor:
        """
        Execute single SQL statement with parameters.
    ...
    def executemany(self, query: str, parameters_list: list) -> sqlite3.Cursor:
        ...
        try:
            ...
            self.logger.error(
                f"Batch query execution failed: {query[:100]}... Error: {e}"
            )
            raise
