...
class PromptService:
    ...
    def __init__(
        ...
        strategy_factory: Optional[PromptStrategyFactory] = None
    ):
        """
        ...
        Args:
            ...
            strategy_factory: Factory for creating prompt strategies (optional, creates default if None)
        """
    ...
    def generate_prompt(
        ...
        available_types = self.strategy_factory.get_available_strategies()
        ...
        strategy = self.strategy_factory.create_strategy(prompt_type)
    ...
    def get_strategy_info(self, prompt_type: str) -> Dict[str, Any]:
        ...
        """
        if not self.strategy_factory.is_strategy_available(prompt_type):
